...
static void init_all() {
    ...
    g_gold_orb_retrace.shadow_mode=false; g_gold_orb_retrace.enabled=true;
    ...
    g_gold_oversold.shadow_mode=false; g_gold_oversold.enabled=true;
    ...
    g_xau_straddle_m15.shadow_mode=false; g_xau_straddle_m15.enabled=true;
    ...
    g_xau_threebar_30m.shadow_mode=false; g_xau_threebar_30m.enabled=true; g_xau_threebar_30m.long_only=true;
    ...
    g_donchian.shadow_mode=false; g_donchian.enabled=true; g_donchian.max_concurrent=7;
    ...
    g_ema_pullback.shadow_mode=false; g_ema_pullback.enabled=true;
...
int main(int argc, char** argv) {
    ...
    fprintf(stderr, "[INIT] configuring + warm-seeding 24 engines ...\n");
    init_all();
