...
public:
    ...
    static constexpr double MAX_RANGE            = 0.005;
    ...
    static constexpr double SL_FRAC              = 0.8;
    ...
    static constexpr double TP_RR                = 2;
    ...
    static constexpr double TRAIL_FRAC           = 0.3;
    ...
    static constexpr double MFE_TRAIL_FRAC       = 0.4;
    ...
    static constexpr double MAX_SPREAD           = 0.0002;
    ...
    static constexpr double LOT_MAX              = 0.2;
