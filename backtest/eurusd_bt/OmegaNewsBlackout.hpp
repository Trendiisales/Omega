...
// that breaks Linux/Mac builds. For the historical backtest we don't have
// a time-aligned NFP/CPI/ECB calendar anyway -- the 14-month sweep treats
// blackout as off. Live promotion uses the real header.
