// =============================================================================
// gold_fixed_rr_longonly_bt.cpp -- alternative mechanism: hard SL + hard TP, no trail
// =============================================================================
// Build: clang++ -O3 -std=c++17 -Iinclude -o backtest/gold_fixed_rr_longonly_bt backtest/gold_fixed_rr_longonly_bt.cpp
// =============================================================================
...
static void apply_config(omega::GoldFixedRREngine& e, const Config& c) {
    ...
    e.LONG_ONLY      = true;       // exploit 2024-03..2026-04 gold bull regime
    e.shadow_mode    = true;
    e.enabled        = true;
}
