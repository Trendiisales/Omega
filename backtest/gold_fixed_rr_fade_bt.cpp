// =============================================================================
// gold_fixed_rr_bt.cpp -- alternative mechanism: hard SL + hard TP, no trail
// =============================================================================
// Build: clang++ -O3 -std=c++17 -Iinclude -o backtest/gold_fixed_rr_bt backtest/gold_fixed_rr_bt.cpp
// =============================================================================
...
static void apply_config(omega::GoldFixedRREngine& e, const Config& c) {
    ...
    e.REVERSE_SIGNAL = true;     // FADE the breakout (mean-reversion hypothesis)
    e.shadow_mode    = true;
    e.enabled        = true;
}
...
int main(int argc, char** argv) {
    ...
    std::printf("===================================================================================\n");
    std::printf("  GoldFixedRR FADE sweep -- reverse signal (fade the M5 breakout)\n");
