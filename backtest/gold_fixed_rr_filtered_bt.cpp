// =============================================================================
// gold_fixed_rr_filtered_bt.cpp -- alternative mechanism: hard SL + hard TP, no trail
// =============================================================================
// Build: clang++ -O3 -std=c++17 -Iinclude -o backtest/gold_fixed_rr_filtered_bt backtest/gold_fixed_rr_filtered_bt.cpp
// =============================================================================
...
static void apply_config(omega::GoldFixedRREngine& e, const Config& c) {
    ...
    e.ATR_FLOOR_OVERRIDE  = 3.0;        // skip low-vol M5 bars
    e.shadow_mode         = true;
    e.enabled             = true;
}
