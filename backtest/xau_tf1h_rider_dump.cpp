...
int main(int argc,char**argv){
 ...
 const char*out =argc>2?argv[2]:"/tmp/xtf_1h_trades.csv";
 ...
 eng.cell_enable_mask=0x0F; eng.lot=0.01; eng.max_spread=1.0; eng.use_vol_target=true; eng.init();
 ...
 std::fclose(tf); std::printf("[1h dump] %d trades net=$%.1f -> %s\n",ntr,net,out); return 0;}
