#pragma once
// =============================================================================
// OmegaTradeLedger.hpp -- BACKTEST STUB (GBPUSD)
// -----------------------------------------------------------------------------
// Minimal stand-in for the production OmegaTradeLedger header. Provides only
// the omega::TradeRecord struct fields that GbpusdLondonOpenEngine writes.
// Compiled into the backtest harness via -I backtest/gbpusd_bt taking
