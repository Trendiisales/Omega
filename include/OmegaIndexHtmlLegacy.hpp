#pragma once
// LEGACY GUI BACKUP (pre 2026-06-12 desk rewrite) -- served at GET /legacy.
// Frozen copy of the old dashboard; new GUI lives in OmegaIndexHtml.hpp
// (generated from tools/gui/omega_desk.html).
namespace omega_gui_legacy {
...
/* ?? CENTRE COLUMN ?? */
.col-centre{grid-column:2;display:flex;flex-direction:column;gap:5px;overflow:hidden;min-height:0;}
...
.pnl-card{background:var(--glass);border:1px solid var(--border);border-radius:10px;
  padding:5px 12px;position:relative;overflow:hidden;}
...
.pnl-num{font-family:'IBM Plex Mono',monospace;font-size:19px;font-weight:700;
  letter-spacing:-0.5px;text-shadow:0 0 20px currentColor;line-height:1;margin:2px 0 1px;}
...
R"OMEGA4(
    ...
    <div class="eng-section">
      ...
      <div class="eng-grid eng-grid-5">
        <div class="eng-cell" id="engSP"><span class="eng-pdh-cnr" id="engSPPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engSPPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-blue">US500</div><div class="eng-ph eph-flat" id="engSPPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engSPHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engSPBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engSPAsk">--</span><span class="eng-lo" id="engSPLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engSPVol">--</div><div class="eng-sigs" id="engSPSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engSPProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engSPPct"></span></div><div class="eng-l2" id="engSPL2"><div class="eng-l2-fill" id="engSPL2F" style="width:50%;background:var(--t3)"></div></div></div>
        <div class="eng-cell" id="engNQ"><span class="eng-pdh-cnr" id="engNQPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engNQPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-blue">USTEC</div><div class="eng-ph eph-flat" id="engNQPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engNQHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engNQBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engNQAsk">--</span><span class="eng-lo" id="engNQLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engNQVol">--</div><div class="eng-sigs" id="engNQSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engNQProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engNQPct"></span></div><div class="eng-l2" id="engNQL2"><div class="eng-l2-fill" id="engNQL2F" style="width:50%;background:var(--t3)"></div></div></div>
        <div class="eng-cell" id="engUS30"><span class="eng-pdh-cnr" id="engUS30Pdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engUS30Pdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-blue">DJ30</div><div class="eng-ph eph-flat" id="engUS30Phase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engUS30Hi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engUS30Bid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engUS30Ask">--</span><span class="eng-lo" id="engUS30Lo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engUS30Vol">--</div><div class="eng-sigs" id="engUS30Sig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engUS30Prox" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engUS30Pct"></span></div><div class="eng-l2" id="engUS30L2"><div class="eng-l2-fill" id="engUS30L2F" style="width:50%;background:var(--t3)"></div></div></div>
        <div class="eng-cell" id="engNAS"><span class="eng-pdh-cnr" id="engNASPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engNASPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-blue">NAS100</div><div class="eng-ph eph-flat" id="engNASPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engNASHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engNASBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engNASAsk">--</span><span class="eng-lo" id="engNASLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engNASVol">--</div><div class="eng-sigs" id="engNASSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engNASProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engNASPct"></span></div><div class="eng-l2" id="engNASL2"><div class="eng-l2-fill" id="engNASL2F" style="width:50%;background:var(--t3)"></div></div></div>
        <div class="eng-cell" id="engCL"><span class="eng-pdh-cnr" id="engCLPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engCLPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym" style="color:var(--amber)">USOIL</div><div class="eng-ph eph-flat" id="engCLPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engCLHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engCLBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engCLAsk">--</span><span class="eng-lo" id="engCLLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engCLVol">--</div><div class="eng-sigs" id="engCLSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engCLProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engCLPct"></span></div><div class="eng-l2" id="engCLL2"><div class="eng-l2-fill" id="engCLL2F" style="width:50%;background:var(--t3)"></div></div></div>
      </div>
    </div>
)OMEGA4"
R"OMEGA4b(
    ...
    <div class="eng-section" style="margin-top:6px;">
      ...
      <div class="eng-grid" style="grid-template-columns:repeat(4,1fr)">
        <div class="eng-cell" id="engGER"><span class="eng-pdh-cnr" id="engGERPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engGERPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-purple">GER40</div><div class="eng-ph eph-flat" id="engGERPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engGERHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engGERBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engGERAsk">--</span><span class="eng-lo" id="engGERLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engGERVol">--</div><div class="eng-sigs" id="engGERSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engGERProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engGERPct"></span></div><div class="eng-l2" id="engGERL2"><div class="eng-l2-fill" id="engGERL2F" style="width:50%;background:var(--t3)"></div></div></div>
        <div class="eng-cell" id="engUK"><span class="eng-pdh-cnr" id="engUKPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engUKPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-purple">UK100</div><div class="eng-ph eph-flat" id="engUKPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engUKHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engUKBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engUKAsk">--</span><span class="eng-lo" id="engUKLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engUKVol">--</div><div class="eng-sigs" id="engUKSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engUKProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engUKPct"></span></div><div class="eng-l2" id="engUKL2"><div class="eng-l2-fill" id="engUKL2F" style="width:50%;background:var(--t3)"></div></div></div>

        <div class="eng-cell" id="engESTX"><span class="eng-pdh-cnr" id="engESTXPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engESTXPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-purple">ESTX50</div><div class="eng-ph eph-flat" id="engESTXPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engESTXHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engESTXBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engESTXAsk">--</span><span class="eng-lo" id="engESTXLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engESTXVol">--</div><div class="eng-sigs" id="engESTXSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engESTXProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engESTXPct"></span></div><div class="eng-l2" id="engESTXL2"><div class="eng-l2-fill" id="engESTXL2F" style="width:50%;background:var(--t3)"></div></div></div>
        <div class="eng-cell" id="engBRENT"><span class="eng-pdh-cnr" id="engBRENTPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engBRENTPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym" style="color:var(--amber)">BRENT</div><div class="eng-ph eph-flat" id="engBRENTPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engBRENTHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engBRENTBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engBRENTAsk">--</span><span class="eng-lo" id="engBRENTLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engBRENTVol">--</div><div class="eng-sigs" id="engBRENTSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engBRENTProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engBRENTPct"></span></div><div class="eng-l2" id="engBRENTL2"><div class="eng-l2-fill" id="engBRENTL2F" style="width:50%;background:var(--t3)"></div></div></div>
      </div>
    </div>
    ...
    <div class="eng-section" style="margin-top:6px;">
      ...
      <div class="eng-grid" style="grid-template-columns:repeat(5,1fr)">
        <div class="eng-cell" id="engEUR"><span class="eng-pdh-cnr" id="engEURPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engEURPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-cyan">EURUSD</div><div class="eng-ph eph-flat" id="engEURPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engEURHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engEURBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engEURAsk">--</span><span class="eng-lo" id="engEURLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engEURVol">--</div><div class="eng-sigs" id="engEURSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engEURProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engEURPct"></span></div><div class="eng-l2" id="engEURL2"><div class="eng-l2-fill" id="engEURL2F" style="width:50%;background:var(--t3)"></div></div></div>
        <div class="eng-cell" id="engGBP"><span class="eng-pdh-cnr" id="engGBPPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engGBPPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-cyan">GBPUSD</div><div class="eng-ph eph-flat" id="engGBPPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engGBPHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engGBPBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engGBPAsk">--</span><span class="eng-lo" id="engGBPLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engGBPVol">--</div><div class="eng-sigs" id="engGBPSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engGBPProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engGBPPct"></span></div><div class="eng-l2" id="engGBPL2"><div class="eng-l2-fill" id="engGBPL2F" style="width:50%;background:var(--t3)"></div></div></div>
        <div class="eng-cell" id="engAUD"><span class="eng-pdh-cnr" id="engAUDPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engAUDPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-teal">AUDUSD</div><div class="eng-ph eph-flat" id="engAUDPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engAUDHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engAUDBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engAUDAsk">--</span><span class="eng-lo" id="engAUDLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engAUDVol">--</div><div class="eng-sigs" id="engAUDSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engAUDProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engAUDPct"></span></div><div class="eng-l2" id="engAUDL2"><div class="eng-l2-fill" id="engAUDL2F" style="width:50%;background:var(--t3)"></div></div></div>
        <div class="eng-cell" id="engNZD"><span class="eng-pdh-cnr" id="engNZDPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engNZDPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym c-teal">NZDUSD</div><div class="eng-ph eph-flat" id="engNZDPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engNZDHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engNZDBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engNZDAsk">--</span><span class="eng-lo" id="engNZDLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engNZDVol">--</div><div class="eng-sigs" id="engNZDSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engNZDProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engNZDPct"></span></div><div class="eng-l2" id="engNZDL2"><div class="eng-l2-fill" id="engNZDL2F" style="width:50%;background:var(--t3)"></div></div></div>
        <div class="eng-cell" id="engJPY"><span class="eng-pdh-cnr" id="engJPYPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engJPYPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym" style="color:var(--purple)">USDJPY</div><div class="eng-ph eph-flat" id="engJPYPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engJPYHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engJPYBid">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engJPYAsk">--</span><span class="eng-lo" id="engJPYLo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engJPYVol">--</div><div class="eng-sigs" id="engJPYSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engJPYProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engJPYPct"></span></div><div class="eng-l2" id="engJPYL2"><div class="eng-l2-fill" id="engJPYL2F" style="width:50%;background:var(--t3)"></div></div></div>
      </div>
    </div>
    ...
    <div class="eng-section" style="margin-top:6px;">
      ...
      <div class="eng-grid" style="grid-template-columns:repeat(1,1fr)">
        <div class="eng-cell" id="engXAU" style="border-color:rgba(245,200,66,0.2);background:rgba(245,200,66,0.04);"><span class="eng-pdh-cnr" id="engXAUPdh" title="Previous session HI (static)" style="position:absolute;top:1px;left:3px;font-size:7px;color:var(--green);font-family:monospace;opacity:0.7;z-index:2">H --</span><span class="eng-pdl-cnr" id="engXAUPdl" title="Previous session LO (static)" style="position:absolute;top:1px;right:3px;font-size:7px;color:var(--red);font-family:monospace;opacity:0.7;z-index:2">L --</span><div class="eng-sym" style="color:var(--gold)">XAUUSD</div><div class="eng-ph eph-flat" id="engXAUPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engXAUHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engXAUBid" style="color:var(--gold)">--</span><span class="eng-sep">|</span><span class="eng-ask" id="engXAUAsk" style="color:var(--red)">--</span><span class="eng-lo" id="engXAULo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span></div><div class="eng-vol" id="engXAUVol">--</div><div class="eng-sigs" id="engXAUSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engXAUProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engXAUPct"></span></div><div class="eng-l2" id="engXAUL2"><div class="eng-l2-fill" id="engXAUL2F" style="width:50%;background:var(--t3)"></div></div></div>
      </div>
    </div>
)OMEGA4b"
R"OMEGA5(
...
R"OMEGA23PDH(
  // S37k 2026-05-26: Write PDH/PDL to NEW corner spans (cellId+'Pdh', cellId+'Pdl')
  // -- separate from the rolling 'engXxxHi/engXxxLo' (which show CURRENT range
  // and are managed elsewhere in updateEngCell). Static once per UTC rollover.
