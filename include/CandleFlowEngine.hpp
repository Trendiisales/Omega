...
static constexpr double  CFE_RSI_THRESH        = 5.0;   // AUDIT 2026-04-29: 3.0 -> 5.0 (cut noise: 3.0 fires on every RSI wiggle)
...
static constexpr int     CFE_DFE_DRIFT_PERSIST_TICKS = 5;   // AUDIT 2026-04-29: 2 -> 5 (require ~1s sustained drift, not 0.2-0.5s)
...
static constexpr double  CFE_DFE_DRIFT_SUSTAINED_THRESH = 0.8;   // AUDIT 2026-04-29: 0.2 -> 0.8 (0.2 produced 21% WR -$6k over 2yr per inline comment line 117)
...
struct CandleFlowEngine {
    ...
    static constexpr bool HMM_GATING_LIVE = true;   // AUDIT 2026-04-29: false -> true (HMM has been shadow-validated; activate regime filter to block NOISE-state entries)
    omega::GoldHMM m_hmm;
...
private:
                ...
                CloseCallback on_close) noexcept
    {
        ...
        if (!pos.partial_done && pos.mfe >= pos.cost_pts * 2.0) {
            ...
            const double partial_size = pos.full_size * 0.50;  // AUDIT 2026-04-29 C-12: REVERT 0.35 -> 0.50. The 35% fraction collapsed avg_win 36% in 26mo BT because it cannibalised partial1 and trail captures.
        ...
        // AUDIT 2026-04-29 C-12: PARTIAL2 block REMOVED. It cannibalised trail captures (TRAIL_SL avg dropped \$2.93 -> \$1.42) for negligible mid-range gain.
        ...
        if (pos.mfe >= pos.atr_pts * 2.0) {  // AUDIT 2026-04-29 C-12: REVERT 1.5 -> 2.0. Earlier arm let trails fire on smaller MFEs that reverted, reducing avg trail capture.
            const double trail_dist = pos.atr_pts * 0.5;  // AUDIT 2026-04-29 C-12: REVERT 0.7 -> 0.5. The looser trail underperformed in 26mo BT.
