...
<!-- ═══ LADDER column-stack (2026-07-08, operator): DOM — XAUUSD L2 + FX LADDER moved to
     UNDER the INDEX LADDER (GER40) table — one .cstack keeps the three in a single column. ═══ -->
<div class="cstack">
