...
R"OMEGA4(
    ...
    <div class="eng-section" style="margin-top:6px;">
      ...
      <div class="eng-grid" style="grid-template-columns:repeat(1,1fr)">
        <div class="eng-cell" id="engXAU" style="border-color:rgba(245,200,66,0.2);background:rgba(245,200,66,0.04);"><div class="eng-sym" style="color:var(--gold)">XAUUSD</div><div class="eng-ph eph-flat" id="engXAUPhase">FLAT</div><div class="eng-px"><span class="eng-hi" id="engXAUHi" title="Prev session HI" style="color:var(--green);font-size:9px;font-family:monospace;margin-right:5px;opacity:0.75">--</span><span class="eng-bid" id="engXAUBid" style="color:var(--gold)">--</span><span class="eng-sep"><span class="eng-lo" id="engXAULo" title="Prev session LO" style="color:var(--red);font-size:9px;font-family:monospace;margin-left:5px;opacity:0.75">--</span>|</span><span class="eng-ask" id="engXAUAsk" style="color:var(--red)">--</span></div><div class="eng-vol" id="engXAUVol">--</div><div class="eng-sigs" id="engXAUSig">0 signals</div><div class="eng-prox"><div class="eng-prox-track"><div class="eng-prox-fill" id="engXAUProx" style="width:0%;background:var(--t3)"></div></div><span class="eng-prox-pct" id="engXAUPct"></span></div><div class="eng-l2" id="engXAUL2"><div class="eng-l2-fill" id="engXAUL2F" style="width:50%;background:var(--t3)"></div></div></div>
      </div>
    </div>
)OMEGA4"
R"OMEGA5(
