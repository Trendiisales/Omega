...
$expected = @{
    "GOLD.F"  = @{ "MIN_RANGE" = "10.00";    "MIN_STRUCTURE_MS" = "30000"; "BREAKOUT_FAIL_MS" = "25000"; "MAX_SPREAD" = "2.50";  "MAX_RANGE" = "18.00"  }
    ...
    "GER30"   = @{ "MIN_RANGE" = "44.00";    "MIN_STRUCTURE_MS" = "30000"; "BREAKOUT_FAIL_MS" = "10000"; "MAX_RANGE" = "90.00"  }
