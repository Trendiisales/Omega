...
int main(int argc, char* argv[])
{
    ...
    // Bar data for all TrendPullback engines comes from cTrader GetTrendbarsReq
    // (pt=2137) -- the same history API the cTrader chart uses. Registered in
    // bar_subscriptions above: XAUUSD M15, US500/USTEC/GER40 M5.
    // No external seeds needed -- Dukascopy and Yahoo removed.
