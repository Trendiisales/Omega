...
// ─────────────────────────────────────────────────────────────────────────────
// Per-symbol tick handlers -- extracted from on_tick() for readability.
// Same translation unit: all globals, helpers, and types are fully visible.
// Logic is IDENTICAL to the original on_tick blocks -- no changes to behaviour.
// ─────────────────────────────────────────────────────────────────────────────
...
static void on_tick(const std::string& sym, double bid, double ask) {
    ...
    // ?? Symbol dispatch -- each handler is in include/tick_*.hpp ??????????????????
